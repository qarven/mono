...
>;
///Shorthand for `OwnedView<CompleteRegistrationRequestView<'static>>`.
pub type OwnedCompleteRegistrationRequestView = ::buffa::view::OwnedView<
    crate::proto::oryon::identity::v1::__buffa::view::CompleteRegistrationRequestView<
        'static,
    >,
>;
///Shorthand for `OwnedView<CompleteRegistrationResponseView<'static>>`.
pub type OwnedCompleteRegistrationResponseView = ::buffa::view::OwnedView<
    crate::proto::oryon::identity::v1::__buffa::view::CompleteRegistrationResponseView<
        'static,
    >,
>;
...
impl ::connectrpc::Encodable<
    crate::proto::oryon::identity::v1::CompleteRegistrationResponse,
>
for crate::proto::oryon::identity::v1::__buffa::view::CompleteRegistrationResponseView<
    '_,
> {
    fn encode(
        &self,
...
/// Static [`Spec`](::connectrpc::Spec) for the `CompleteRegistration` RPC, as seen by the server; the generated client passes it with [`origin`](::connectrpc::Spec::origin) `Client` (compare across sides with [`Spec::same_method`](::connectrpc::Spec::same_method)).
pub const AUTHENTICATION_SERVICE_COMPLETE_REGISTRATION_SPEC: ::connectrpc::Spec = ::connectrpc::Spec::server(
        "/oryon.identity.v1.AuthenticationService/CompleteRegistration",
        ::connectrpc::StreamType::Unary,
    )
    .with_idempotency_level(::connectrpc::IdempotencyLevel::Unknown);
...
pub trait AuthenticationService: Send + Sync + 'static {
    ...
    fn registration<'a>(
        ...
        >,
    > + Send;
    /// Handle the CompleteRegistration RPC.
    ///
    /// `'a` lets the response body borrow from `&self` (e.g. server-resident state).
    ///
    /// `request` is borrowed from the request body and is valid for the
    ...
    /// `.to_owned_message()` (or copy the specific fields) for anything
    /// returned, stored, or moved into `tokio::spawn`.
    fn complete_registration<'a>(
        &'a self,
        ctx: ::connectrpc::RequestContext,
        request: ::connectrpc::ServiceRequest<
            '_,
            crate::proto::oryon::identity::v1::CompleteRegistrationRequest,
        >,
    ) -> impl ::std::future::Future<
        Output = ::connectrpc::ServiceResult<
            impl ::connectrpc::Encodable<
                        ...
                        format|
                    {
                        ...
                        async move {
                            let sreq = ::connectrpc::ServiceRequest::<
                                crate::proto::oryon::identity::v1::CompleteRegistrationRequest,
                            >::from_parts(req.reborrow(), req.bytes());
                            svc.complete_registration(ctx, sreq)
                                .await?
                                .encode::<
                                    crate::proto::oryon::identity::v1::CompleteRegistrationResponse,
                                >(format)
            ...
            "CompleteRegistration" => {
                ...
                Box::pin(async move {
                    let body = ::connectrpc::dispatcher::codegen::request_proto_bytes::<
                        crate::proto::oryon::identity::v1::CompleteRegistrationRequest,
                    >(request.encoded()?, format)?;
                    let req: crate::proto::oryon::identity::v1::__buffa::view::CompleteRegistrationRequestView<
                        '_,
                    > = ::connectrpc::dispatcher::codegen::decode_borrowed_request_view(
                        &body,
                        ctx.decode_options(),
                    ...
                    let req = ::connectrpc::ServiceRequest::<
                        crate::proto::oryon::identity::v1::CompleteRegistrationRequest,
                    >::from_parts(&req, &body);
                    svc.complete_registration(ctx, req)
                        .await?
                        .encode::<
                            crate::proto::oryon::identity::v1::CompleteRegistrationResponse,
                        >(format)
    ...
    <T::ResponseBody as ::connectrpc::http_body::Body>::Error: ::std::fmt::Display,
{
    ...
    /// Call the CompleteRegistration RPC. Sends a request to /oryon.identity.v1.AuthenticationService/CompleteRegistration.
    pub async fn complete_registration(
        &self,
        request: crate::proto::oryon::identity::v1::CompleteRegistrationRequest,
    ) -> Result<
        ::connectrpc::client::UnaryResponse<
            ::buffa::view::OwnedView<
                crate::proto::oryon::identity::v1::__buffa::view::CompleteRegistrationResponseView<
        ...
        ::connectrpc::ConnectError,
    > {
        self.complete_registration_with_options(
                request,
                ::connectrpc::client::CallOptions::default(),
            )
            .await
    }
    /// Call the CompleteRegistration RPC with explicit per-call options. Options override [`ClientConfig`](::connectrpc::client::ClientConfig) defaults.
    pub async fn complete_registration_with_options(
        &self,
        request: crate::proto::oryon::identity::v1::CompleteRegistrationRequest,
        options: ::connectrpc::client::CallOptions,
    ) -> Result<
    ...
    > {
        ::connectrpc::client::call_unary(
                &self.transport,
                &self.config,
                AUTHENTICATION_SERVICE_COMPLETE_REGISTRATION_SPEC
                    .with_origin(::connectrpc::SpecOrigin::Client),
                request,
                options,
            )
